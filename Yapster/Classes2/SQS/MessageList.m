...
-(void)viewWillAppear:(BOOL)animated
{
    ...
    dispatch_async(queue, ^{
        ...
        SQSReceiveMessageRequest *messageRequest = [[SQSReceiveMessageRequest alloc] initWithQueueUrl:self.queue];
...
-(void)tableView:(UITableView *)tableView commitEditingStyle:(UITableViewCellEditingStyle)editingStyle forRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (editingStyle == UITableViewCellEditingStyleDelete) {
        ...
        dispatch_async(dispatchQueue, ^{
            ...
            SQSDeleteMessageRequest *deleteMessageRequest = [[SQSDeleteMessageRequest alloc] initWithQueueUrl:self.queue andReceiptHandle:selectedMessage.receiptHandle];
