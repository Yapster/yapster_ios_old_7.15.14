...
-(IBAction)uploadImages:(id)sender
{
    ...
    AsyncImageUploader *imageUploader2 = [[AsyncImageUploader alloc] initWithImageNo:2 progressView:nil];
    ...
    [operationQueue addo:imageUploader3];
...
-(void)deleteBucket
{
    ...
    for (S3ObjectSummary *os in listResponse.listObjectsResult.objectSummaries)
    {
        ...
        {
            DLog(@"Error: %@", deleteObjectResponse.error);
        }
    ...
    {
        DLog(@"Error: %@", deleteBucketResponse.error);
    }
