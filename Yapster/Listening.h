...
@interface Listening : UIViewController <UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, UITableViewDataSource, UITableViewDelegate, UIScrollViewDelegate, AmazonServiceRequestDelegate> {
    
    IBOutlet UILabel *label_following_count;
    IBOutlet UILabel *label_following;
